...
def construct_nec_folders(project_path):
     """Check if specific file paths exist (necessary for input and output datasets). If they do 
     not exist call the function build_folders() and create the folder.
    ...
    Returns:
    --------
    Creates the respective folders if they are not yet existent
    ...
    path_input_raw_data_2 = project_path + 'src/original_data/Mergent_FISD'
